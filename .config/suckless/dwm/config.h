...
#include "/home/anon/.config/suckless/dwm/themes/theme.h"
...
static const char *fonts[]          = { "JetBrainsMono Nerd Font:style=Bold:size=8:antialias=true", "Material Design Icons:Regular:size=11:antialias=true" };
